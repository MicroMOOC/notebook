...
# 安装lab插件
RUN jupyter labextension install /home/jovyan/jupyterlab/packages/filebrowser
RUN jupyter labextension install /home/jovyan/jupyterlab/packages/notebook-extension
